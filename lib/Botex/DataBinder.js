Botex.DataBinder = Bricks.inherit(Bricks.Observer, {
    ...
    renderClassName: function(container) {
        ...
        this._lastValue = this._prepareClassName(this._fn.call(this._ctx));
        this._lastValue.forEach(function(cls) {
            Bricks.DOM.addClassName(container, cls);
            this._fireEvent('addclass', {
                el: container,
                className: cls
            });
        }, this);
        container.className += ' ' + this._lastValue.join(' ');
    },
    ...
    update: function() {
        ...
        if (this._mode === 'cls') {
            newValue = this._prepareClassName(newValue);
            this._lastValue.forEach(function(cls) {
            ...
            newValue.forEach(function(cls) {
                if (this._lastValue.indexOf(cls) === -1) {
    ...
    _prepareClassName: function(cls) {
        cls = Bricks.String.trim(cls);
