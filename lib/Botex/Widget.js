Botex.Widget = Bricks.inherit(Botex.Tag, {
    ...
    constructor: function() {
        ...
        this._domEventsController.pause();
        this._eventsController.pause();
    },
    ...
    mount: function(parentEl, beforeEl) {
        ...
        this._domEventsController.resume();
        this._eventsController.resume();
    ...
    _appendContent: function(container, beforeEl, content) {
        if (content instanceof Quantum.Array) {
